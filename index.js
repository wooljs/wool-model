...
class Event {
  constructor(t, o, name, data, status, message) {
    ...
    if (! (data instanceof Object)) throw new Error(data+' is not of type Object.')
  ...
  static parse(s) {
    ...
    return new Event(new Date(e[_index_t]), Number.parseInt(e[_index_o],16), e[_index_n], JSON.parse(e[_index_d]), e[_index_s] || undefined, e[_index_m || undefined])
  }
  static stringify(e) {
    return e.stringify()
  }
